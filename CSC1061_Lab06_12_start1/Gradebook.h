...
public:
    ...
    virtual double GetScore(string assignmentName, int studentID) = 0;

    // SetScore() adds or updates a score in the gradebook.
    virtual void SetScore(string assignmentName, int studentID,
        double score) = 0;
    ...
    virtual unordered_map<string, double> GetStudentScores(
        int studentID) = 0;
};
